...
int main(int argc, char* argv[])
{
 ...
 /*Step1: Getting platforms and choose an available one.*/
       ...
       if (status != CL_SUCCESS)
   {
    ...
    auto  num  = N;
    std::vector<cl_short, AAlloc::AlignedAllocator<cl_short, 64> > Keys_in;
    std::vector<cl_short, AAlloc::AlignedAllocator<cl_short, 64> > Keys_out(num);
    std::vector<cl_short, AAlloc::AlignedAllocator<cl_short, 64> > Keys_out2(M);
